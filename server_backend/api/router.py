...
from server_backend.api.v1.pdf_index import router as pdf_index_router
from server_backend.api.v1.graph import router as graph_router
...
api_router.include_router(pdf_index_router, prefix="/v1", tags=["pdf"])
api_router.include_router(graph_router, prefix="/v1", tags=["graph"])